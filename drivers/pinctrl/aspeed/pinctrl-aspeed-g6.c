...
GROUP_DECL(EMMCG9, AB4, AA4, AC4, AA5, Y5, AB5, Y1, Y2, Y3, Y4);
FUNC_DECL_2(FWSPID, FWSPID, FWQSPID);
FUNC_GROUP_DECL(VB, Y1, Y2, Y3, Y4);
FUNC_DECL_5(EMMC, EMMCG1, EMMCG4, EMMCG5, EMMCG8, EMMCG9);
/*
...
static const struct aspeed_pin_group aspeed_g6_groups[] = {
	...
	ASPEED_PINCTRL_GROUP(EMMCG5),
	ASPEED_PINCTRL_GROUP(EMMCG8),
	ASPEED_PINCTRL_GROUP(EMMCG9),
