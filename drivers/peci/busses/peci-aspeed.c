...
static inline int aspeed_peci_check_idle(struct aspeed_peci *priv)
{
	...
	return readl_poll_timeout(priv->base + ASPEED_PECI_CMD, cmd_sts,
			    ...
			    struct peci_xfer_msg *msg)
{
	...
	print_hex_dump_debug("TX : ", DUMP_PREFIX_NONE, 16, 1, msg->tx_buf,
			     msg->tx_len, true);
	...
	print_hex_dump_debug("RX : ", DUMP_PREFIX_NONE, 16, 1, msg->rx_buf,
			     msg->rx_len, true);
...
static int aspeed_peci_init_ctrl(struct aspeed_peci *priv)
{
	...
	writel(FIELD_PREP(ASPEED_PECI_TIMING_NEGO_SEL_MASK,
	       ...
	       priv->base + ASPEED_PECI_INT_CTRL);
